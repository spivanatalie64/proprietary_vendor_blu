...
#prize modify by linchong 20210520 start
#CUSTOM_HAL_IMGSENSOR = imx586_mipi_raw imx576_mipi_raw s5k3m5sx_mipi_raw imx481_mipi_raw imx519_mipi_raw imx398_mipi_raw imx350_mipi_raw s5k2l7_mipi_raw imx386_mipi_raw imx386_mipi_mono s5k2t7sp_mipi_raw imx499_mipi_raw
CUSTOM_HAL_IMGSENSOR = ov64b404cell_mipi_raw ov64b40_mipi_raw ov16a1q_mipi_raw gc5035wide_mipi_raw bf2253L_mipi_raw bf2253Lmacro_mipi_raw
#prize modify by linchong 20210520 end
CUSTOM_HAL_MAIN2_IMGSENSOR = gc5035wide_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = ov64b40_mipi_raw
CUSTOM_HAL_MSENSORLIB = af6133e
...
#prize modify by linchong 20210520 start
#CUSTOM_KERNEL_IMGSENSOR = imx586_mipi_raw imx576_mipi_raw s5k3m5sx_mipi_raw imx481_mipi_raw imx519_mipi_raw imx398_mipi_raw imx350_mipi_raw s5k2l7_mipi_raw imx386_mipi_raw imx386_mipi_mono s5k2t7sp_mipi_raw imx499_mipi_raw
CUSTOM_KERNEL_IMGSENSOR = ov64b404cell_mipi_raw ov64b40_mipi_raw ov16a1q_mipi_raw gc5035wide_mipi_raw bf2253L_mipi_raw bf2253Lmacro_mipi_raw
#prize modify by linchong 20210521 end
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LINEARACCEL_SENSOR = yes
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc5035wide_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_IMGSENSOR = ov64b40_mipi_raw
...
CUSTOM_MODEM=K6607-NLWCG_MP_6833-G2358W1245F24512131725266671T41N252541667177_BLU
...
#prize modify by baibo for finger start
MICROTRUST_TEE_SUPPORT = yes
#prize modify by baibo for finger end
MNTL_SUPPORT = no
...
#prize add by wuhui for aw88194 sktune 20210625 start
PRIZE_AUDIO_AWINIC_MEC_SKT2 = yes
#prize add by wuhui for aw88194 sktune 20210625 end
...
#prize modify by wanrenxiang for camera start
MTK_CAM_MFB_MAX_FRAME = 6
#prize modify by wanrenxiang for camera end
...
#rize modified by tangan,enable mtklog-20200925-begin
MTK_LOG_CUSTOMER_SUPPORT  = yes
#rize modified by tangan,enable mtklog-20200925-end
...
MTK_PUMP_EXPRESS_PLUS_50_SUPPORT = yes
...
#rize modified by tangan,enable signature-20200925-begin
MTK_SIGNATURE_CUSTOMIZATION  = yes
#rize modified by tangan,enable signature-20200925-end
...
#prize modify by baibo for finger end
#prize modify by baibo for FACE start
MICROTRUST_TEE_TFACE = yes
#prize modify by baibo for FACE end
...
MTK_TOUCHPANEL_FIRMWARE = synaptics
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
...
PRIZE_FINGER_PRINT_GOODIX = gw9518_tee
PRIZE_FINGER_PRINT_FT = ft9618_tee
#prize modify by baibo for finger end

#prize-lanweiming-20200925,add PRIZE_SW_VERSION-start
PRIZE_SW_VERSION=K6607U2BL.PRIZE.FHD.$(PRIZE_FLASH_CODE).$(shell date +%m%d).V1.01
...
PRIZE_BOARD_NETWORK_TYPE = NB/LfB/LtB/WB/GB
...
#efuse 工具熔断标识 和 工厂模式efuse熔断信息测试项
PRIZE_MTK_ENABLE_EFUSE=yes
...
#finger
#PRIZE_FINGER_PRINT = cdfinger_ree_daoge
